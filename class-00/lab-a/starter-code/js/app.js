...
function displayPics(){
  ...
  // From my understanding it threw an error because the console log was outside the function. I'm assuming with let we are unable to console log outside the function  
  console.log(viewed);
