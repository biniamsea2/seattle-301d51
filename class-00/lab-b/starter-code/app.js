...
// It refers to the object student

// 2. What is "this" when joe.scopeArrow() is invoked?
// "This" is referring to the entire window browser.

// 3. Explain why "this" is different when an arrow function is used.
// You are unable to use "this" when using an arrow function, it will use the parent's "this" which is the windows.